<?php
		...
		{
			if($_GET['action'] == 'user_premission_add')
			{
				...
				$idPermission = insertUserPermission($idAuthor, $idSection, $nameRu, $nameEn, $description, $permission, $ip, $userAgent);
                
                if($idPermission)
                  $ancor = '#noticeUserPermissionAdd';
                else
                  $ancor = '#noticeUserPermissionError';
                redirect($ancor);
			}
    }
?>