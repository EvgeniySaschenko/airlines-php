...
// Подсветка рисков
(function() {
  var indexRiskBefore, indexRiskAfter;
  
    function colorHighlighting(selector, value) {
        // Красный
        if(value == '5A' || value == '4A' || value == '3A' || value == '5B' || value == '4B' || value == '5C') {
             selector.css('backgroundColor', '#fd0100')
        }

        // Желтый
        if(value == '5D' || value == '5E' || value == '4C' || value == '4D' || value == '4E' || value == '3B' || value == '3C' || value == '3D' || value == '2A' || value == '2B' || value == '2C') {
             selector.css('backgroundColor', '#ffff01')
        }

        // Зеленый 
        if(value == '1А' || value == '1B' || value == '1C' || value == '1D' || value == '1E' || value == '2D' || value == '2E' || value == '3E') {
             selector.css('backgroundColor', '#00af50')
        }
    }
