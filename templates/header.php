...
<html>
  ...
  data-lang="<?= $lang; ?>"
  data-permission-all="<?= $currentUser[0]['permission']; ?>"
  ...
  data-permission-assignment-flight="<?php if($permissionAssignmentFlight): echo md5($permissionAssignmentFlight); endif;?>"
