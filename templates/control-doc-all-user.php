<div class="control__doc-all-user">
  <table class="table table-striped table-bordered tablesorter tablesorter-control__doc-all-user">
    <thead>
      <tr>
    ...
    <tbody>
    <?php foreach($allUserAllSectionControl as $user): ?>
      <?php if($user['hide'] == 0 and !empty($user['date_end_doc'])): ?>
