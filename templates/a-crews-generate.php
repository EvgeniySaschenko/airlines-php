...
<div class="a-crews-generate panel-group accordion-open-first-tab" id="collapse-a-crews-generate">
    ...
    <div class="panel panel-default">
      ...
      <div id="crew<?= $crew['id']; ?>" class="panel-collapse collapse accordion-item">
        <div class="panel-body">
          ...
          <div class="a-crew-generate a-crew-generate--<?= $crew['location_en']; ?>" data-id-section="<?= $crew['id_section']; ?>" data-priority="<?= $crew['priority']; ?>" data-locatio="<?= $crew['location_en']; ?>">
                 ...
                 <tr>
                    ...
                    <td class="a-crew-generate__aircraft">
                      ...
                      <?php foreach($allAircraft as $aircraft): ?>
                         <?php if(strstr($crew['name_ru'], '76')) { $selected = 'selected'; } ?>
                          <option <?= $selected ?> value="<?= $aircraft['id'] ?>"><?= $aircraft['name_'.$lang].' '.$aircraft['model'] ?></option>
                          <?php unset($selected); ?>
                        <?php endforeach; ?>
                      </select>
                    </td>
                   ...
                   <!--Дата вылета-->
                    ...
                    <td class="a-crew-generate__number-assignment">
                      ...
                      <div class="form-group text-center">
                        <div class="input-group">
                          <input name="number_assignment"  type="text">
                        </div>
                      </div>
                    </td>
                 </tr>
